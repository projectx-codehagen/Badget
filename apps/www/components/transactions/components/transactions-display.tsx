        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex flex-col">
              <span className="text-m font-semibold">Account</span>
              {/* Replace with actual data for the Account */}
              <Button variant="outline">Account X</Button>
            </div>
            <div className="flex flex-col">
              <span className="text-m font-semibold">Category</span>
              {/* Replace with actual data for the badge */}
              <PopoverBadgeTransaction />
            </div>
          </div>
