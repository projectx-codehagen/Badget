...
export async function POST(request: NextRequest) {
    ...
    const requestTexts = {
        ...
        swedish: "Jag vill att du agerar som en fastighetsmäklare. Jag skulle vilja att du skapar text baserad på den bild du får, och skriver en detaljerad och tilltalande egendomsbeskrivning. Stilen bör vara professionell, och beskrivningen bör vara ungefär en mening lång. Jag vill ha 3 olika meningar så att jag kan välja. Inkludera unika funktioner och framhäv vad som gör denna egendom speciell.",
        norwegian: "Jeg ønsker at du skal opptre som en eiendomsmegler. Jeg vil at du skal lage tekst basert på bildet du mottar, og skrive en detaljert og tiltalende eiendomsbeskrivelse. Stilen skal være profesjonell, og beskrivelsen skal være omtrent én setning lang. Jeg ønsker 3 forskjellige setninger slik at jeg kan velge. Inkluder unike funksjoner og fremhev hva som gjør denne eiendommen spesiell."
    };
    ...
    try {
        ...
        console.log("Image analysis completed, response data:", JSON.stringify(response.data, null, 2));
