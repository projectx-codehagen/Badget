...
const todayDate = formatDateISO(0); // Today
const yesterdayDate = formatDateISO(1); // Yesterday
// For other dates, you can use subDays with the desired number of days ago
