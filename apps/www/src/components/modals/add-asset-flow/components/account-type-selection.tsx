...
import { Bitcoin, Building, Car, GitGraph, MoreHorizontal } from "lucide-react";

import { Label } from "@dingify/ui/components/label";
import { RadioGroup, RadioGroupItem } from "@dingify/ui/components/radio-group";
...
export const AccountTypeSelection = ({ onSelectAccountType }) => {
